...
import { Eye, Plus, Clock, CheckCircle, AlertCircle } from "lucide-react";
...
export default async function SpyProjectsPage() {
            ...
            {projectsWithCounts.length > 0 ? (
                <div className="grid gap-3">
                    {projectsWithCounts.map((project) => {
                        ...
                        return (
                            <Link key={project.id} href={`/dashboard/spy/${project.id}`}>
